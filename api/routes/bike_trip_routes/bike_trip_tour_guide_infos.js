...
router.post('/post_bike_trip_tour_guide_info',(req,res)=>{

    const bike_trip_tour_guide_info= new Bike_Trip_Tour_Guide_Info({
    ...
    bike_trip_tour_guide_info.save()
    .then(result=>{
        res.json({
            message:'bike_trip_tour_guide_info_data_saved_successfully',
            data:result
        });
    })
    .catch(err=>{
...
router.get('/get_bike_trip_tour_guide_info/:package_id',(req,res)=>{
    Bike_Trip_Tour_Guide_Info.find({
...
router.get('/send_data_to_bike_trip_tour_guide',(req,res)=>{
