...
router.post('/post_weekend_trip_tour_guide_info',(req,res)=>{

    const weekend_trip_tour_guide_info= new Weekend_Trip_Tour_Guide_Info({
    ...
    weekend_trip_tour_guide_info.save()
    .then(result=>{
        res.json({
            message:'weekend_trip_tour_guide_info_data_saved_successfully',
            data:result
        });
    })
    .catch(err=>{
...
router.get('/get_weekend_trip_tour_guide_info/:package_id',(req,res)=>{
    Weekend_Trip_Tour_Guide_Info.find({
...
router.get('/send_data_to_weekend_trip_tour_guide',(req,res)=>{
