...
router.post('/post_weekend_trip_user_booking_detail',(req,res)=>{

    const weekend_trip_user_booking_detail=new Weekend_Trip_User_Booking_Detail({
    ...
    weekend_trip_user_booking_detail.extra_data_in_object_type['user_ns']=req.body.user_ns;
    
    weekend_trip_user_booking_detail.save()
    .then(result1=>{
        res.status(200).json({
